...
/**
  * Taken from https://raw.githubusercontent.com/Thangiee/Freasy-Monad/master/core/shared/src/test/scala/examples/cats/ComposeFreeMonads.scala
  */
...
object ComposeFreeMonads extends App {
  ...
  def program1(implicit I: Interact.Injects[CatsApp],
               D: DataSource.Injects[CatsApp]): Free[CatsApp, Unit] = {
    import I._, D._
    for {
