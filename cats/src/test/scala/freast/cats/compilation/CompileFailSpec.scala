...
/**
  * Taken from https://github.com/Thangiee/Freasy-Monad/blob/master/core/shared/src/test/scala/compilation/CompileFailSpec.scala
  */
class CompileFailSpec extends FunSuite with Matchers {
  test("Compiler error when val do not have explicit return type") {
    """
      |import cats.free._
      |@freast.cats.free trait KVStore {
