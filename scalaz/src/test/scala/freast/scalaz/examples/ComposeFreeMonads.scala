package freast.scalaz.examples

/**
  * Taken from https://github.com/Thangiee/Freasy-Monad/blob/master/core/shared/src/test/scala/examples/scalaz/ComposeFreeMonads.scala
  */
import scalaz._
import scalaz.Id.Id
import freast.scalaz.free
...
object ComposeFreeMonads extends App {
  ...
  def program1(implicit I: Interact.Injects[ScalazApp],
               D: DataSource.Injects[ScalazApp]): Free[ScalazApp, Unit] = {
    import I._, D._
    for {
